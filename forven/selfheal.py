...
dummy_df = pd.DataFrame(
    {{
        ...
        "close": close,
        "volume": volume,
        "funding_rate": np.linspace(0.0001, 0.0002, num=100),
        "basis": np.linspace(0.1, 0.5, num=100),
        "open_interest": np.linspace(10000.0, 20000.0, num=100),
        "ls_ratio": np.linspace(1.1, 1.2, num=100),
        "long_pct": np.linspace(0.51, 0.52, num=100),
        "short_pct": np.linspace(0.49, 0.48, num=100),
        "taker_buy_sell_ratio": np.linspace(0.95, 1.05, num=100),
        "iv_btc": np.linspace(0.45, 0.48, num=100),
        "iv_eth": np.linspace(0.50, 0.53, num=100),
        "long_liq_usd": np.linspace(100.0, 200.0, num=100),
        "short_liq_usd": np.linspace(100.0, 200.0, num=100),
        "liq_imbalance": np.linspace(-0.1, 0.1, num=100),
    }},
    index=index,
)
